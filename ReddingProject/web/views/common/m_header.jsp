...
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/css/common/m_header.css">
	...
	<div class="east">
		<%if (memberID == null){%>
			<ul class = "login_menu">
					...
					<li><a href = "<%=request.getContextPath() %>/views/common/login.jsp">login</a></li>
